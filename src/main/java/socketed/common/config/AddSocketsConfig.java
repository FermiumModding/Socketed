...
public class AddSocketsConfig {
	...
	@Config.Comment("Base chance for items sold by villagers to attempt to roll with sockets")
	@Config.Name("Merchant Socket Chance")
	@Config.RangeDouble(min = 0, max = 1)
	public float chanceOnMerchant = 0.2F;

	@Config.Comment("Base chance for items generated by general loot pools (excluding pre-defined socketed items) to attempt to roll with sockets")
	@Config.Name("General Loot Socket Chance")
	@Config.RangeDouble(min = 0, max = 1)
	public float chanceOnLootGen = 0.2F;

	@Config.Comment("Base chance for items generated by mob loot pools to attempt to roll with sockets")
